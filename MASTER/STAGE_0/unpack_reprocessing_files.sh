...
Usage:
  unpack_reprocessing_files.sh <station>
...
base_directory="$HOME/DATAFLOW_v3/STATIONS/MINGO0${station}/STAGE_0"
...
hld_input_directory=$HOME/DATAFLOW_v3/MASTER/STAGE_0/UNPACKER_ZERO_STAGE_FILES/system/devices/TRB3/data/daqData/rawData/dat
asci_output_directory=$HOME/DATAFLOW_v3/MASTER/STAGE_0/UNPACKER_ZERO_STAGE_FILES/system/devices/TRB3/data/daqData/asci
first_stage_raw_directory=$HOME/DATAFLOW_v3/STATIONS/MINGO0${station}/STAGE_1/EVENT_DATA/RAW
first_stage_base=$HOME/DATAFLOW_v3/STATIONS/MINGO0${station}/STAGE_1/EVENT_DATA
first_stage_base_deep=$HOME/DATAFLOW_v3/STATIONS/MINGO0${station}/STAGE_1/EVENT_DATA/RAW_TO_LIST/RAW_TO_LIST_FILES
...
# Get list of all existing filenames under STAGE_1/EVENT_DATA recursively
...
$HOME/DATAFLOW_v3/MASTER/STAGE_0/UNPACKER_ZERO_STAGE_FILES/bin/unpack.sh
...
for station in {1..4}; do
    ...
    station_dir="${BASE_ROOT}/MINGO${station_id}/STAGE_0"
    ...
    for subdir in "${SUBDIRS[@]}"; do
        ...
        find "$current_dir" -maxdepth 1 -type f -name "mi0*.dat" | while read -r file; do
            ...
            if [[ "$file_station" != "$station_id" ]]; then
                target_dir="${BASE_ROOT}/MINGO${file_station}/STAGE_0/${subdir}"
