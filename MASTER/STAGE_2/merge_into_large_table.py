...
directories = {
    "event_data": os.path.join(base_folder, "STAGE_1/EVENT_DATA"),
    "lab_logs": os.path.join(base_folder, "STAGE_1/LAB_LOGS"),
    "copernicus": os.path.join(base_folder, "STAGE_1/COPERNICUS"),
}

output_directory = os.path.join(base_folder, "STAGE_2")
